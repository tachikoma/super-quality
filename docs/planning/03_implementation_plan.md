...
- [x] 벤치마크, 체결 비용, provenance 계약, WF 오케스트레이션, 의미 수정에 대한
  회귀 테스트 추가.
- [x] PIT 데이터 게이트 통과 후 PIT 파라미터 민감도 실행.
  (2026-08-16, 기계적 진단: proxy Day 12 + PIT Day 16 — 모멘텀 가중 0.7/0.3
  개선 신호, 손절 MDD 방어 유효. classification 승격 전이므로 검증된 결론 아님.)
- [x] 계획된 스트레스 테스트 시나리오 실행.
  (2026-08-16, 기계적 진단: proxy Day 13 + PIT Day 17 — 손절 비활성 시 MDD 급증.)
- [x] 현재 구성원과 역사 구성원 사이의 생존자 편향 비교 완료.
  (2026-08-16, Day 14: PIT 유니버스 323 유니크 vs proxy 198, 2015-05-29 기준
  ~46% 상이, stitched -23.6%p 하향.)
